...
export const ThemeComparison: Story = {
  ...
  render: () => html`
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0; min-height: 200px;">
      <div data-theme="light" style="padding: 2rem; background: #ffffff;">
        <p
        ...
        <hx-prose>
          ...
          <p>
            Follow evidence-based protocols for all clinical decisions. Document all interventions
      ...
      <div data-theme="dark" style="padding: 2rem; background: #1a1a2e;">
        <p
