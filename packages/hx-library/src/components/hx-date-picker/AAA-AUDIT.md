...
**Audit run:** 2026-05-10T19:46:01.416Z
...
**Evidence:** box-shadow focus indicator: oklab(0 0 0 / 0) 0px 0px 0px 0px (keyboard-focused via Tab×1 on <div> (shadow descendant of <hx-date-picker> — focus ring rendered on inner part)). Verify >=2px effective thickness + 3:1 contrast manually.
