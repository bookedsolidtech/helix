...
**Audit run:** 2026-05-10T20:15:12.512Z
...
| 2.3.3 | Animation from Interactions | Supports | All interaction-driven motion respects `prefers-reduced-motion: reduce` | Component has 4 transition + 1 animation declaration(s) and at least one @media (prefers-reduced-motion: reduce) guard. | [spec](https://www.w3.org/TR/WCAG22/#animation-from-interactions) |
...
| 2.4.13 | Focus Appearance | Supports | Outline ≥2px perimeter; focused-vs-unfocused contrast ≥3:1 | outline 0px none rgb(0, 0, 0); box-shadow=color(srgb 0.0509804 0.0941176 0.145098 / 0.12) 0px 4px 16px 0px; keyboard-focus via Tab×1 | [spec](https://www.w3.org/TR/WCAG22/#focus-appearance) |
...
**Measured:** Component has 4 transition + 1 animation declaration(s) and at least one @media (prefers-reduced-motion: reduce) guard.
...
**Measured:** outline 0px none rgb(0, 0, 0); box-shadow=color(srgb 0.0509804 0.0941176 0.145098 / 0.12) 0px 4px 16px 0px; keyboard-focus via Tab×1

**Evidence:** box-shadow focus indicator: color(srgb 0.0509804 0.0941176 0.145098 / 0.12) 0px 4px 16px 0px (keyboard-focused via Tab×1 on <div> (shadow descendant of <hx-combobox> — focus ring rendered on inner part)). Verify >=2px effective thickness + 3:1 contrast manually.
...
**Measured:** target=hx-combobox 1184.0×71.0 px
...
**Measured:** @aria-pattern="combobox" — all required key groups referenced (ArrowDown, ArrowUp, Escape, Enter).

**Evidence:** @aria-pattern="combobox" — all required key groups referenced (ArrowDown, ArrowUp, Escape, Enter).

**APG pattern reference:** [https://www.w3.org/WAI/ARIA/apg/patterns/combobox/](https://www.w3.org/WAI/ARIA/apg/patterns/combobox/)
...
- **Source class:** [`packages/hx-library/src/components/hx-combobox/hx-combobox.ts`](../../../../packages/hx-library/src/components/hx-combobox/hx-combobox.ts)
- **Source styles:** [`packages/hx-library/src/components/hx-combobox/hx-combobox.styles.ts`](../../../../packages/hx-library/src/components/hx-combobox/hx-combobox.styles.ts)
- **Stories:** [`packages/hx-library/src/components/hx-combobox/hx-combobox.stories.ts`](../../../../packages/hx-library/src/components/hx-combobox/hx-combobox.stories.ts)
- **Per-cell evidence (gitignored):** `.reports/formal-aaa-audit/evidence/hx-combobox.json`
- **Aggregate matrix (gitignored):** `.reports/formal-aaa-audit/audit.matrix.md`
- **Storybook URL audited:** `http://localhost:3151/iframe.html?id=components-combobox--default&viewMode=story`
...
- The component's class file (`packages/hx-library/src/components/hx-combobox/hx-combobox.ts`) or styles file (`packages/hx-library/src/components/hx-combobox/hx-combobox.styles.ts`) is modified.
