...
**Audit run:** 2026-05-10T19:46:21.772Z
...
**Measured:** outline 0px none rgb(0, 0, 0); box-shadow=oklab(0 0 0 / 0) 0px 0px 0px 0px; keyboard-focus via Tab×1

**Evidence:** box-shadow focus indicator: oklab(0 0 0 / 0) 0px 0px 0px 0px (keyboard-focused via Tab×1 on <div> (shadow descendant of <hx-number-input> — focus ring rendered on inner part)). Verify >=2px effective thickness + 3:1 contrast manually.
