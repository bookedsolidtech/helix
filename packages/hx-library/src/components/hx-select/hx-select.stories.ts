...
export const Default: Story = {
  ...
  play: async ({ canvasElement }) => {
    const select = canvasElement.querySelector('hx-select');
...
export const Sizes: Story = {
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 1.5rem; max-width: 400px;">
      <hx-select label="Small" wc-size="sm" placeholder="Select...">
        <option value="a">Option A</option>
        <option value="b">Option B</option>
      </hx-select>

      <hx-select label="Medium (default)" wc-size="md" placeholder="Select...">
        <option value="a">Option A</option>
        <option value="b">Option B</option>
      </hx-select>

      <hx-select label="Large" wc-size="lg" placeholder="Select...">
        <option value="a">Option A</option>
        <option value="b">Option B</option>
      </hx-select>
    </div>
...
export const AllStates: Story = {
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 1.5rem; max-width: 400px;">
      ...
      <hx-select label="Required (empty)" placeholder="This is required" required>
        <option value="a">Option A</option>
        <option value="b">Option B</option>
      </hx-select>

      <hx-select label="With Error" placeholder="Select..." error="This field is required.">
        <option value="a">Option A</option>
        <option value="b">Option B</option>
      </hx-select>

      <hx-select label="With Help Text" placeholder="Select..." help-text="Additional guidance here.">
        <option value="a">Option A</option>
        <option value="b">Option B</option>
      </hx-select>
      ...
      <hx-select label="With Value" value="b">
        <option value="a">Option A</option>
        <option value="b">Option B</option>
      </hx-select>
    </div>
