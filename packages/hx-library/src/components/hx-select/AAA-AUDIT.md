...
**Audit run:** 2026-05-10T11:51:04.790Z
...
**Measured:** target=hx-select 1184.0×69.0 px
...
- **Source class:** [`packages/hx-library/src/components/hx-select/hx-select.ts`](../../../../packages/hx-library/src/components/hx-select/hx-select.ts)
- **Source styles:** [`packages/hx-library/src/components/hx-select/hx-select.styles.ts`](../../../../packages/hx-library/src/components/hx-select/hx-select.styles.ts)
- **Stories:** [`packages/hx-library/src/components/hx-select/hx-select.stories.ts`](../../../../packages/hx-library/src/components/hx-select/hx-select.stories.ts)
- **Per-cell evidence (gitignored):** `.reports/formal-aaa-audit/evidence/hx-select.json`
- **Aggregate matrix (gitignored):** `.reports/formal-aaa-audit/audit.matrix.md`
- **Storybook URL audited:** `http://localhost:3151/iframe.html?id=components-select--default&viewMode=story`
...
- The component's class file (`packages/hx-library/src/components/hx-select/hx-select.ts`) or styles file (`packages/hx-library/src/components/hx-select/hx-select.styles.ts`) is modified.
