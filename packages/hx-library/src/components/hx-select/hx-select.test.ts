...
describe('hx-select', () => {
  ...
  describe('Rendering', () => {
    it('renders with shadow DOM', async () => {
      const _el = await fixture<WcSelect>('<hx-select></hx-select>');
  ...
  describe('Property: label', () => {
    it('renders label text', async () => {
      const _el = await fixture<WcSelect>('<hx-select label="Country"></hx-select>');
    ...
    it('shows asterisk when required', async () => {
      const _el = await fixture<WcSelect>('<hx-select label="Country" required></hx-select>');
  ...
  describe('Property: placeholder', () => {
    it('renders placeholder as first disabled option', async () => {
      const _el = await fixture<WcSelect>('<hx-select placeholder="Choose..."></hx-select>');
  ...
  describe('Property: value', () => {
    it('reflects value attribute', async () => {
      const _el = await fixture<WcSelect>('<hx-select value="opt1"></hx-select>');
  ...
  describe('Property: size', () => {
    ...
    it('applies sm size class', async () => {
      const _el = await fixture<WcSelect>('<hx-select wc-size="sm"></hx-select>');
      const select = shadowQuery(el, '.field__select--sm');
      expect(select).toBeTruthy();
    });

    it('applies lg size class', async () => {
      const _el = await fixture<WcSelect>('<hx-select wc-size="lg"></hx-select>');
  ...
  describe('Property: error', () => {
    it('renders error message in role="alert" div', async () => {
      const _el = await fixture<WcSelect>('<hx-select error="Required field"></hx-select>');
    ...
    it('error div has aria-live="polite"', async () => {
      const _el = await fixture<WcSelect>('<hx-select error="Required"></hx-select>');
    ...
    it('error hides help text', async () => {
      const _el = await fixture<WcSelect>('<hx-select error="Error" help-text="Help"></hx-select>');
  ...
  describe('Property: helpText', () => {
    it('renders help text below select', async () => {
      const _el = await fixture<WcSelect>('<hx-select help-text="Pick carefully"></hx-select>');
      const helpText = shadowQuery(el, '.field__help-text');
    ...
    it('help text hidden when error present', async () => {
      const _el = await fixture<WcSelect>('<hx-select help-text="Help" error="Error"></hx-select>');
      const helpText = shadowQuery(el, '.field__help-text');
      expect(helpText).toBeNull();
    });
  });
  ...
  describe('Property: required', () => {
    it('sets required attr on native select', async () => {
      const _el = await fixture<WcSelect>('<hx-select required></hx-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
  ...
  describe('Property: disabled', () => {
    it('sets disabled attr on native select', async () => {
      const _el = await fixture<WcSelect>('<hx-select disabled></hx-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
  ...
  describe('Property: name', () => {
    it('sets name attr on native select', async () => {
      const _el = await fixture<WcSelect>('<hx-select name="country"></hx-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
  ...
  describe('Property: ariaLabel', () => {
    it('sets aria-label on native select', async () => {
      const _el = await fixture<WcSelect>('<hx-select aria-label="Select country"></hx-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
  ...
  describe('Events', () => {
    it('dispatches wc-change on selection', async () => {
      const _el = await fixture<WcSelect>(`
        <hx-select>
  ...
  describe('Slots', () => {
    ...
    it('help-text slot renders', async () => {
      const _el = await fixture<WcSelect>('<hx-select help-text="default"><em slot="help-text">Custom help</em></hx-select>');
  ...
  describe('CSS Parts', () => {
    it('label part exposed', async () => {
      const _el = await fixture<WcSelect>('<hx-select label="Test"></hx-select>');
    ...
    it('error part exposed', async () => {
      const _el = await fixture<WcSelect>('<hx-select error="Error"></hx-select>');
      const error = shadowQuery(el, '[part="error"]');
      expect(error).toBeTruthy();
    });

    it('help-text part exposed', async () => {
      const _el = await fixture<WcSelect>('<hx-select help-text="Help"></hx-select>');
  ...
  describe('Form', () => {
    ...
    it('form getter returns associated form', async () => {
      ...
      const _el = form.querySelector('hx-select') as WcSelect;
      await el.updateComplete;
      expect(el.form).toBe(form);
    });

    it('formResetCallback resets value to empty', async () => {
      const _el = await fixture<WcSelect>('<hx-select value="hello"></hx-select>');
  ...
  describe('Validation', () => {
    ...
    it('checkValidity returns true when required + filled', async () => {
      const _el = await fixture<WcSelect>('<hx-select required value="filled"></hx-select>');
  ...
  describe('Accessibility', () => {
    ...
    it('aria-describedby references error ID when error set', async () => {
      const _el = await fixture<WcSelect>('<hx-select error="Bad input"></hx-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
      const errorDiv = shadowQuery(el, '.field__error')!;
    ...
    it('aria-describedby references help text ID when helpText set', async () => {
      const _el = await fixture<WcSelect>('<hx-select help-text="Some help"></hx-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
  ...
  describe('Accessibility (axe-core)', () => {
    it('has no axe violations in default state', async () => {
      const _el = await fixture<WcSelect>(`<hx-select label="Country">
    ...
    it('has no axe violations in error state', async () => {
      const _el = await fixture<WcSelect>(`<hx-select label="Country" error="Required">
        <option value="us">United States</option>
      </hx-select>`);
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
    ...
    it('has no axe violations when disabled', async () => {
      const _el = await fixture<WcSelect>(`<hx-select label="Country" disabled>
        <option value="us">United States</option>
      </hx-select>`);
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
