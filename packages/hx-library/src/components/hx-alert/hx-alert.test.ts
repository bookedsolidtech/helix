...
describe('hx-alert', () => {
  ...
  describe('Rendering', () => {
    it('renders with shadow DOM', async () => {
      const _el = await fixture<WcAlert>('<hx-alert>Test</hx-alert>');
      expect(el.shadowRoot).toBeTruthy();
    });

    it('renders the alert container', async () => {
      const _el = await fixture<WcAlert>('<hx-alert>Test message</hx-alert>');
      const alert = shadowQuery(el, '.alert');
      expect(alert).toBeTruthy();
    });

    it('renders default slot content', async () => {
      const _el = await fixture<WcAlert>('<hx-alert>Hello world</hx-alert>');
      expect(el.textContent?.trim()).toContain('Hello world');
    });

    it('is visible by default (open=true)', async () => {
      const _el = await fixture<WcAlert>('<hx-alert>Visible</hx-alert>');
  ...
  describe('Property: variant', () => {
    it('defaults to "info"', async () => {
      const _el = await fixture<WcAlert>('<hx-alert>Default variant</hx-alert>');
      expect(el.variant).toBe('info');
    });

    it('reflects variant attribute to property', async () => {
      const _el = await fixture<WcAlert>('<hx-alert variant="error">Error</hx-alert>');
      expect(el.variant).toBe('error');
    });

    it('applies "success" variant via attribute', async () => {
      const _el = await fixture<WcAlert>('<hx-alert variant="success">Success</hx-alert>');
      expect(el.getAttribute('variant')).toBe('success');
    });

    it('applies "warning" variant via attribute', async () => {
      const _el = await fixture<WcAlert>('<hx-alert variant="warning">Warning</hx-alert>');
  ...
  describe('Property: closable', () => {
    it('defaults to false', async () => {
      const _el = await fixture<WcAlert>('<hx-alert>Not closable</hx-alert>');
      expect(el.closable).toBe(false);
    });

    it('renders close button when closable', async () => {
      const _el = await fixture<WcAlert>('<hx-alert closable>Closable</hx-alert>');
  ...
  describe('Property: open', () => {
    it('defaults to true', async () => {
      const _el = await fixture<WcAlert>('<hx-alert>Open</hx-alert>');
      expect(el.open).toBe(true);
    });

    it('hides alert when open is false', async () => {
      const _el = await fixture<WcAlert>('<hx-alert>Hidden</hx-alert>');
      el.open = false;
  ...
  describe('Slots', () => {
    it('default slot renders message content', async () => {
      const _el = await fixture<WcAlert>('<hx-alert>Alert message here</hx-alert>');
      expect(el.textContent?.trim()).toContain('Alert message here');
    });

    it('icon slot renders custom icon', async () => {
      const _el = await fixture<WcAlert>(
  ...
  describe('CSS Parts', () => {
    ...
    it('exposes "close-button" part when closable', async () => {
      const _el = await fixture<WcAlert>('<hx-alert closable>Test</hx-alert>');
  ...
  describe('Accessibility', () => {
    it('uses role="status" for info variant', async () => {
      const _el = await fixture<WcAlert>('<hx-alert variant="info">Info</hx-alert>');
      const alert = shadowQuery(el, '.alert')!;
  ...
  describe('Default icons', () => {
    it('renders a default SVG icon per variant', async () => {
      ...
      for (const variant of variants) {
        const _el = await fixture<WcAlert>(`<hx-alert variant="${variant}">Test</hx-alert>`);
  ...
  describe('Accessibility (axe-core)', () => {
    it('has no axe violations in default state', async () => {
      const _el = await fixture<WcAlert>('<hx-alert>This is an alert</hx-alert>');
    ...
    it('has no axe violations for all variants', async () => {
      for (const variant of ['info', 'success', 'warning', 'error']) {
        const _el = await fixture<WcAlert>(`<hx-alert variant="${variant}">Alert message</hx-alert>`);
        await page.screenshot();
        const { violations } = await checkA11y(el);
    ...
    it('has no axe violations when closable', async () => {
      const _el = await fixture<WcAlert>('<hx-alert closable>Closable alert</hx-alert>');
      await page.screenshot();
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
    });
