...
**Source:** `packages/hx-library/src/components/hx-file-upload/hx-file-upload.ts`
...
**Audit run:** 2026-05-10T11:50:45.350Z
...
| --- | --- | --- | --- | --- | --- |
| 1.4.6 | Contrast (Enhanced) | Supports | Normal text ≥7:1; large text (≥18.66px or ≥14px bold) ≥4.5:1 | 10.20:1 (fg rgb(49, 62, 75), bg rgb(245, 248, 243)) | [spec](https://www.w3.org/TR/WCAG22/#contrast-enhanced) |
...
**Measured:** 10.20:1 (fg rgb(49, 62, 75), bg rgb(245, 248, 243))
...
**Measured:** target=hx-file-upload 1184.0×128.0 px
...
- **Source class:** [`packages/hx-library/src/components/hx-file-upload/hx-file-upload.ts`](../../../../packages/hx-library/src/components/hx-file-upload/hx-file-upload.ts)
- **Source styles:** [`packages/hx-library/src/components/hx-file-upload/hx-file-upload.styles.ts`](../../../../packages/hx-library/src/components/hx-file-upload/hx-file-upload.styles.ts)
- **Stories:** [`packages/hx-library/src/components/hx-file-upload/hx-file-upload.stories.ts`](../../../../packages/hx-library/src/components/hx-file-upload/hx-file-upload.stories.ts)
- **Per-cell evidence (gitignored):** `.reports/formal-aaa-audit/evidence/hx-file-upload.json`
- **Aggregate matrix (gitignored):** `.reports/formal-aaa-audit/audit.matrix.md`
- **Storybook URL audited:** `http://localhost:3151/iframe.html?id=components-file-upload--default&viewMode=story`
...
- The component's class file (`packages/hx-library/src/components/hx-file-upload/hx-file-upload.ts`) or styles file (`packages/hx-library/src/components/hx-file-upload/hx-file-upload.styles.ts`) is modified.
