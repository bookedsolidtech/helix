...
`navigate=Arrow,Home,End,PageUp,PageDown; disabled-suppresses=true`
...
Snapshot path: `packages/hx-library/__screenshots__/forced-colors/hx-slider/*.png`
