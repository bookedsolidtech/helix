...
**Component:** `hx-slider`
**Source:** `packages/hx-library/src/components/hx-slider/hx-slider.ts`
...
**Audit run:** 2026-05-10T11:51:07.739Z
...
| 2.5.5 | Target Size (Enhanced) | Not Applicable | Target ≥44×44 CSS px (essential / equivalent / inline / UA-control exceptions per WCAG 2.2) | target=hx-slider 1184.0×35.0 px | [spec](https://www.w3.org/TR/WCAG22/#target-size-enhanced) |
...
**Measured:** target=hx-slider 1184.0×35.0 px

**Evidence:** User-agent-controlled target — component delegates to a native <input type="range"> whose thumb is sized by the platform (typically 16-20px). WCAG 2.5.5 user-agent exception (https://www.w3.org/TR/WCAG22/#target-size-enhanced) applies: target sized by the user agent is exempt. Host bbox 1184.0x35.0 px reflects the entire slider track, not the actionable thumb. Equivalent input methods (Arrow keys, Home/End, PageUp/PageDown, mouse wheel) clear the spirit of 2.5.5 for keyboard users.
...
**Measured:** @aria-pattern="slider" — component renders a native element that provides the canonical keyboard contract via the user agent (no custom handler required).
...
- **Source class:** [`packages/hx-library/src/components/hx-slider/hx-slider.ts`](../../../../packages/hx-library/src/components/hx-slider/hx-slider.ts)
- **Source styles:** [`packages/hx-library/src/components/hx-slider/hx-slider.styles.ts`](../../../../packages/hx-library/src/components/hx-slider/hx-slider.styles.ts)
- **Stories:** [`packages/hx-library/src/components/hx-slider/hx-slider.stories.ts`](../../../../packages/hx-library/src/components/hx-slider/hx-slider.stories.ts)
- **Per-cell evidence (gitignored):** `.reports/formal-aaa-audit/evidence/hx-slider.json`
- **Aggregate matrix (gitignored):** `.reports/formal-aaa-audit/audit.matrix.md`
- **Storybook URL audited:** `http://localhost:3151/iframe.html?id=components-slider--default&viewMode=story`
...
- The component's class file (`packages/hx-library/src/components/hx-slider/hx-slider.ts`) or styles file (`packages/hx-library/src/components/hx-slider/hx-slider.styles.ts`) is modified.
