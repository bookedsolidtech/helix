...
export const Small: Story = {
  ...
  decorators: [
    (story) => html`
      <div
        style="display: inline-flex; align-items: center; gap: 0.75rem; padding: 1rem 1.5rem; border: 1px solid #e5e7eb; border-radius: 0.5rem; background: #f9fafb; min-width: 14rem; font: 0.875rem system-ui, sans-serif;"
      >
