...
export const Default: Story = {
  ...
  play: async ({ canvasElement }) => {
    const button = canvasElement.querySelector('hx-card');
...
export const WithAllSlots: Story = {
  render: () => html`
    <hx-card elevation="raised" style="max-width: 400px;">
      ...
      <span slot="actions">
        <hx-button wc-size="sm">Action 1</hx-button>
        <hx-button wc-size="sm" variant="secondary">Action 2</hx-button>
      </span>
    </hx-card>
  `,
};
...
export const Featured: Story = {
  render: () => html`
    <hx-card variant="featured" elevation="raised" style="max-width: 400px;">
      ...
      <span slot="actions">
        <hx-button wc-size="sm">Learn More</hx-button>
      </span>
    </hx-card>
  `,
};
...
export const Compact: Story = {
  render: () => html`
    <hx-card variant="compact" style="max-width: 300px;">
...
export const ElevationComparison: Story = {
  render: () => html`
    <div style="display: flex; gap: 1.5rem; flex-wrap: wrap;">
      <hx-card elevation="flat" style="max-width: 240px;">
        <span slot="heading">Flat</span>
        <p>No shadow elevation.</p>
      </hx-card>

      <hx-card elevation="raised" style="max-width: 240px;">
        <span slot="heading">Raised</span>
        <p>Medium shadow elevation.</p>
      </hx-card>

      <hx-card elevation="floating" style="max-width: 240px;">
