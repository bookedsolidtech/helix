  ...
  render: (args) => html`
    <div style="display: flex; justify-content: center; padding: 4rem 2rem;">
      ...
      >
        ...
        <button role="menuitem" style="color: #7a0e0e;">Delete</button>
      </hx-overflow-menu>
    </div>
  `,
} satisfies Meta;
        ...
        <tr style="border-bottom: 1px solid #e5e7eb;">
          ...
          <td style="padding: 0.5rem 1rem; text-align: right;">
            <hx-overflow-menu role="menu" hx-size="sm" placement="bottom-end">
              ...
              <button role="menuitem" style="color: #7a0e0e;">
                Discharge
              </button>
            </hx-overflow-menu>
          </td>
  ...
  render: () => html`
    <div style="display: flex; justify-content: center; padding: 4rem 2rem;">
      <hx-overflow-menu role="menu">
        ...
        <button
          role="menuitem"
          style="display: flex; align-items: center; gap: 0.5rem; color: #7a0e0e;"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
