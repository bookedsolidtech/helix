...
describe('hx-container', () => {
  ...
  describe('Rendering', () => {
    it('renders with shadow DOM', async () => {
      const _el = await fixture<WcContainer>('<hx-container>Content</hx-container>');
  ...
  describe('Property: padding', () => {
    ...
    it('padding="sm" reflected as attribute', async () => {
      const _el = await fixture<WcContainer>('<hx-container padding="sm">Content</hx-container>');
      expect(el.getAttribute('padding')).toBe('sm');
    });

    it('padding="md" reflected as attribute', async () => {
      const _el = await fixture<WcContainer>('<hx-container padding="md">Content</hx-container>');
      expect(el.getAttribute('padding')).toBe('md');
    });

    it('padding="lg" reflected as attribute', async () => {
      const _el = await fixture<WcContainer>('<hx-container padding="lg">Content</hx-container>');
      expect(el.getAttribute('padding')).toBe('lg');
    });

    it('padding="xl" reflected as attribute', async () => {
      const _el = await fixture<WcContainer>('<hx-container padding="xl">Content</hx-container>');
      expect(el.getAttribute('padding')).toBe('xl');
    });

    it('padding="2xl" reflected as attribute', async () => {
      const _el = await fixture<WcContainer>('<hx-container padding="2xl">Content</hx-container>');
  ...
  describe('Slot: default', () => {
    it('slotted content renders', async () => {
      const _el = await fixture<WcContainer>('<hx-container><p>Hello World</p></hx-container>');
    ...
    it('multiple children render', async () => {
      const _el = await fixture<WcContainer>(
