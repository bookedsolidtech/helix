...
`hx-container` is a layout-only component with no ARIA role. Screen readers announce slotted content directly, bypassing the container element itself. No additional accessibility configuration is required.
