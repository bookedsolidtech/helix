...
import type { WcTheme } from './hx-theme.js';
import './index.js';
...
describe('hx-theme', () => {
  ...
  describe('Rendering', () => {
    it('renders with shadow DOM', async () => {
      const el = await fixture<WcTheme>('<hx-theme>Content</hx-theme>');
    ...
    it('renders slotted content', async () => {
      const el = await fixture<WcTheme>('<hx-theme><p id="test-p">Hello</p></hx-theme>');
  ...
  describe('Property: theme', () => {
    ...
    it('reflects theme attribute to host', async () => {
      const el = await fixture<WcTheme>('<hx-theme theme="dark">Content</hx-theme>');
    ...
    it('accepts "high-contrast" theme', async () => {
      const el = await fixture<WcTheme>('<hx-theme theme="high-contrast">Content</hx-theme>');
  ...
  describe('Property: system', () => {
    ...
    it('reflects system attribute to host', async () => {
      const el = await fixture<WcTheme>('<hx-theme system>Content</hx-theme>');
  ...
  describe('Token values', () => {
    ...
    it('injects light --hx-shadow-sm in light mode', async () => {
      const el = await fixture<WcTheme>('<hx-theme theme="light">Content</hx-theme>');
      await el.updateComplete;
  ...
  describe('System detection', () => {
    ...
    it('effectiveTheme ignores theme prop when system=true', async () => {
      const el = await fixture<WcTheme>('<hx-theme system theme="dark">Content</hx-theme>');
      await el.updateComplete;
  ...
  describe('Slots', () => {
    it('default slot renders text content', async () => {
      const el = await fixture<WcTheme>('<hx-theme>Themed Content</hx-theme>');
      expect(el.textContent?.trim()).toBe('Themed Content');
    });

    it('default slot renders HTML children', async () => {
      const el = await fixture<WcTheme>(
