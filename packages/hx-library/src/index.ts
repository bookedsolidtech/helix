...
export type { WcContainer as HxContainer } from './components/hx-container/index.js';
...
export type { WcDivider as HxDivider } from './components/hx-divider/index.js';
...
export type { WcNav as HxNav } from './components/hx-nav/index.js';
