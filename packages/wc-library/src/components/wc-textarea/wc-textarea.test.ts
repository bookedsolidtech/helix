...
describe('wc-textarea', () => {
  ...
  describe('Rendering', () => {
    it('renders with shadow DOM', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea></wc-textarea>');
  ...
  describe('Property: label', () => {
    it('renders label text', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea label="Description"></wc-textarea>');
    ...
    it('shows asterisk when required', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea label="Notes" required></wc-textarea>');
  ...
  describe('Property: placeholder', () => {
    it('sets placeholder attr on native textarea', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea placeholder="Enter notes..."></wc-textarea>');
  ...
  describe('Property: value', () => {
    it('syncs value to native textarea', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea value="hello"></wc-textarea>');
      const textarea = shadowQuery<HTMLTextAreaElement>(el, 'textarea')!;
  ...
  describe('Property: rows', () => {
    ...
    it('sets custom rows attribute', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea rows="8"></wc-textarea>');
      const textarea = shadowQuery<HTMLTextAreaElement>(el, 'textarea')!;
  ...
  describe('Property: maxlength', () => {
    it('sets maxlength attr on native textarea', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea maxlength="200"></wc-textarea>');
      const textarea = shadowQuery<HTMLTextAreaElement>(el, 'textarea')!;
  ...
  describe('Property: resize', () => {
    ...
    it('reflects resize attribute to host', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea resize="none"></wc-textarea>');
  ...
  describe('Property: showCount', () => {
    ...
    it('renders counter when show-count is set', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea show-count></wc-textarea>');
      const counter = shadowQuery(el, '[part="counter"]');
      expect(counter).toBeTruthy();
    });

    it('shows "count / maxlength" format when maxlength set', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea show-count maxlength="200" value="hello"></wc-textarea>');
      const counter = shadowQuery(el, '[part="counter"]');
  ...
  describe('Property: required', () => {
    it('sets required attr on native textarea', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea required></wc-textarea>');
      const textarea = shadowQuery<HTMLTextAreaElement>(el, 'textarea')!;
  ...
  describe('Property: disabled', () => {
    it('sets disabled attr on native textarea', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea disabled></wc-textarea>');
      const textarea = shadowQuery<HTMLTextAreaElement>(el, 'textarea')!;
  ...
  describe('Property: error', () => {
    it('renders error message in role="alert" div', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea error="Required field"></wc-textarea>');
    ...
    it('error div has aria-live="polite"', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea error="Required"></wc-textarea>');
    ...
    it('error hides help text', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea error="Error" help-text="Help"></wc-textarea>');
  ...
  describe('Property: helpText', () => {
    it('renders help text below textarea', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea help-text="Enter your notes"></wc-textarea>');
      const helpText = shadowQuery(el, '.field__help-text');
    ...
    it('help text hidden when error present', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea help-text="Help" error="Error"></wc-textarea>');
      const helpText = shadowQuery(el, '.field__help-text');
      expect(helpText).toBeNull();
    });
  });
  ...
  describe('Slots', () => {
    it('help-text slot renders', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea help-text="default"><em slot="help-text">Custom help</em></wc-textarea>');
  ...
  describe('CSS Parts', () => {
    it('label part exposed', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea label="Test"></wc-textarea>');
  ...
  describe('Form', () => {
    it('has formAssociated=true', () => {
      const ctor = customElements.get('wc-textarea') as unknown as { formAssociated: boolean };
    ...
    it('form getter returns associated form', async () => {
      ...
      form.innerHTML = '<wc-textarea name="test"></wc-textarea>';
      document.getElementById('test-fixture-container')!.appendChild(form);
      const el = form.querySelector('wc-textarea') as WcTextarea;
      await el.updateComplete;
  ...
  describe('Validation', () => {
    ...
    it('checkValidity returns true when required + filled', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea required value="filled"></wc-textarea>');
  ...
  describe('Methods', () => {
    ...
    it('select() selects text in native textarea', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea value="hello world"></wc-textarea>');
      el.focus();
      el.select();
      await new Promise((r) => setTimeout(r, 50));
      const textarea = shadowQuery<HTMLTextAreaElement>(el, 'textarea')!;
  ...
  describe('aria-describedby', () => {
    it('references error ID when error set', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea error="Bad input"></wc-textarea>');
      const textarea = shadowQuery<HTMLTextAreaElement>(el, 'textarea')!;
      const errorDiv = shadowQuery(el, '.field__error')!;
    ...
    it('references help text ID when helpText set', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea help-text="Some help"></wc-textarea>');
      const textarea = shadowQuery<HTMLTextAreaElement>(el, 'textarea')!;
  ...
  describe('Auto-resize', () => {
    it('sets resize="auto" attribute on host', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea resize="auto"></wc-textarea>');
  ...
  describe('Character Counter', () => {
    it('shows count only when no maxlength', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea show-count value="test"></wc-textarea>');
      const counter = shadowQuery(el, '[part="counter"]');
      expect(counter?.textContent?.trim()).toBe('4');
    });

    it('counter still visible when error is set', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea show-count error="Error" value="hello"></wc-textarea>');
      const counter = shadowQuery(el, '[part="counter"]');
      expect(counter).toBeTruthy();
  ...
  describe('Property: name', () => {
    it('sets name attr on native textarea', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea name="notes"></wc-textarea>');
      const textarea = shadowQuery<HTMLTextAreaElement>(el, 'textarea')!;
  ...
  describe('Property: ariaLabel', () => {
    it('sets aria-label on native textarea', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea aria-label="Notes field"></wc-textarea>');
      const textarea = shadowQuery<HTMLTextAreaElement>(el, 'textarea')!;
  ...
  describe('Accessibility (axe-core)', () => {
    it('has no axe violations in default state', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea label="Notes"></wc-textarea>');
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
    });

    it('has no axe violations in error state', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea label="Notes" error="Required field"></wc-textarea>');
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
    });

    it('has no axe violations when disabled', async () => {
      const el = await fixture<WcTextarea>('<wc-textarea label="Notes" disabled></wc-textarea>');
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
    });
