...
describe('wc-select', () => {
  ...
  describe('Rendering', () => {
    it('renders with shadow DOM', async () => {
      const el = await fixture<WcSelect>('<wc-select></wc-select>');
  ...
  describe('Property: label', () => {
    it('renders label text', async () => {
      const el = await fixture<WcSelect>('<wc-select label="Country"></wc-select>');
    ...
    it('shows asterisk when required', async () => {
      const el = await fixture<WcSelect>('<wc-select label="Country" required></wc-select>');
  ...
  describe('Property: placeholder', () => {
    it('renders placeholder as first disabled option', async () => {
      const el = await fixture<WcSelect>('<wc-select placeholder="Choose..."></wc-select>');
  ...
  describe('Property: value', () => {
    it('reflects value attribute', async () => {
      const el = await fixture<WcSelect>('<wc-select value="opt1"></wc-select>');
  ...
  describe('Property: size', () => {
    ...
    it('applies sm size class', async () => {
      const el = await fixture<WcSelect>('<wc-select wc-size="sm"></wc-select>');
      const select = shadowQuery(el, '.field__select--sm');
      expect(select).toBeTruthy();
    });

    it('applies lg size class', async () => {
      const el = await fixture<WcSelect>('<wc-select wc-size="lg"></wc-select>');
  ...
  describe('Property: error', () => {
    it('renders error message in role="alert" div', async () => {
      const el = await fixture<WcSelect>('<wc-select error="Required field"></wc-select>');
    ...
    it('error div has aria-live="polite"', async () => {
      const el = await fixture<WcSelect>('<wc-select error="Required"></wc-select>');
    ...
    it('error hides help text', async () => {
      const el = await fixture<WcSelect>('<wc-select error="Error" help-text="Help"></wc-select>');
  ...
  describe('Property: helpText', () => {
    it('renders help text below select', async () => {
      const el = await fixture<WcSelect>('<wc-select help-text="Pick carefully"></wc-select>');
      const helpText = shadowQuery(el, '.field__help-text');
    ...
    it('help text hidden when error present', async () => {
      const el = await fixture<WcSelect>('<wc-select help-text="Help" error="Error"></wc-select>');
      const helpText = shadowQuery(el, '.field__help-text');
      expect(helpText).toBeNull();
    });
  });
  ...
  describe('Property: required', () => {
    it('sets required attr on native select', async () => {
      const el = await fixture<WcSelect>('<wc-select required></wc-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
  ...
  describe('Property: disabled', () => {
    it('sets disabled attr on native select', async () => {
      const el = await fixture<WcSelect>('<wc-select disabled></wc-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
  ...
  describe('Property: name', () => {
    it('sets name attr on native select', async () => {
      const el = await fixture<WcSelect>('<wc-select name="country"></wc-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
  ...
  describe('Property: ariaLabel', () => {
    it('sets aria-label on native select', async () => {
      const el = await fixture<WcSelect>('<wc-select aria-label="Select country"></wc-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
  ...
  describe('Events', () => {
    ...
    it('wc-change detail.value is correct', async () => {
      const el = await fixture<WcSelect>(`
        <wc-select>
          <option value="a">A</option>
          <option value="b">B</option>
  ...
  describe('Slots', () => {
    ...
    it('help-text slot renders', async () => {
      const el = await fixture<WcSelect>('<wc-select help-text="default"><em slot="help-text">Custom help</em></wc-select>');
  ...
  describe('CSS Parts', () => {
    it('label part exposed', async () => {
      const el = await fixture<WcSelect>('<wc-select label="Test"></wc-select>');
    ...
    it('error part exposed', async () => {
      const el = await fixture<WcSelect>('<wc-select error="Error"></wc-select>');
      const error = shadowQuery(el, '[part="error"]');
      expect(error).toBeTruthy();
    });

    it('help-text part exposed', async () => {
      const el = await fixture<WcSelect>('<wc-select help-text="Help"></wc-select>');
  ...
  describe('Form', () => {
    it('has formAssociated=true', () => {
      const ctor = customElements.get('wc-select') as unknown as { formAssociated: boolean };
    ...
    it('form getter returns associated form', async () => {
      ...
      form.innerHTML = '<wc-select name="test"></wc-select>';
      document.getElementById('test-fixture-container')!.appendChild(form);
      const el = form.querySelector('wc-select') as WcSelect;
      await el.updateComplete;
      expect(el.form).toBe(form);
    });

    it('formResetCallback resets value to empty', async () => {
      const el = await fixture<WcSelect>('<wc-select value="hello"></wc-select>');
  ...
  describe('Validation', () => {
    ...
    it('checkValidity returns true when required + filled', async () => {
      const el = await fixture<WcSelect>('<wc-select required value="filled"></wc-select>');
  ...
  describe('Accessibility', () => {
    ...
    it('aria-describedby references error ID when error set', async () => {
      const el = await fixture<WcSelect>('<wc-select error="Bad input"></wc-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
      const errorDiv = shadowQuery(el, '.field__error')!;
    ...
    it('aria-describedby references help text ID when helpText set', async () => {
      const el = await fixture<WcSelect>('<wc-select help-text="Some help"></wc-select>');
      const select = shadowQuery<HTMLSelectElement>(el, 'select')!;
  ...
  describe('Accessibility (axe-core)', () => {
    it('has no axe violations in default state', async () => {
      const el = await fixture<WcSelect>(`<wc-select label="Country">
    ...
    it('has no axe violations in error state', async () => {
      const el = await fixture<WcSelect>(`<wc-select label="Country" error="Required">
        <option value="us">United States</option>
      </wc-select>`);
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
    ...
    it('has no axe violations when disabled', async () => {
      const el = await fixture<WcSelect>(`<wc-select label="Country" disabled>
        <option value="us">United States</option>
      </wc-select>`);
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
