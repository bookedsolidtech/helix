...
import { wcSelectStyles } from './wc-select.styles.js';
 ...
 *
 * @fires {CustomEvent<{value: string}>} wc-change - Dispatched when the selected option changes.
 *
 ...
 *
 * @cssprop [--wc-select-bg=var(--wc-color-neutral-0)] - Select background color.
 * @cssprop [--wc-select-color=var(--wc-color-neutral-800)] - Select text color.
 * @cssprop [--wc-select-border-color=var(--wc-color-neutral-300)] - Select border color.
 * @cssprop [--wc-select-border-radius=var(--wc-border-radius-md)] - Select border radius.
 * @cssprop [--wc-select-font-family=var(--wc-font-family-sans)] - Select font family.
 * @cssprop [--wc-select-focus-ring-color=var(--wc-focus-ring-color)] - Focus ring color.
 * @cssprop [--wc-select-error-color=var(--wc-color-error-500)] - Error state color.
 * @cssprop [--wc-select-label-color=var(--wc-color-neutral-700)] - Label text color.
 * @cssprop [--wc-select-chevron-color=var(--wc-color-neutral-500)] - Chevron indicator color.
 */
@customElement('wc-select')
export class WcSelect extends LitElement {
  static override styles = [tokenStyles, wcSelectStyles];
   ...
   * @attr wc-size
   */
  @property({ type: String, attribute: 'wc-size', reflect: true })
  size: 'sm' | 'md' | 'lg' = 'md';
