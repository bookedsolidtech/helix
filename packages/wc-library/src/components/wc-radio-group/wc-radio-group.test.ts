...
import type { WcRadioGroup } from './wc-radio-group.js';
import type { WcRadio } from './wc-radio.js';
import './index.js';

afterEach(cleanup);

describe('wc-radio-group', () => {
  ...
  describe('Rendering: Group', () => {
    it('renders with shadow DOM', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `);
    ...
    it('renders legend with label text', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Choose One">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `);
  ...
  describe('Rendering: Radio', () => {
    it('wc-radio renders with shadow DOM', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test">
          <wc-radio value="a" label="Option A"></wc-radio>
        </wc-radio-group>
      `);
      const radio = el.querySelector('wc-radio') as WcRadio;
      expect(radio.shadowRoot).toBeTruthy();
    });

    it('wc-radio renders label text', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test">
          <wc-radio value="a" label="Option A"></wc-radio>
        </wc-radio-group>
    ...
    it('wc-radio exposes "radio" CSS part', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
    ...
    it('wc-radio exposes "label" CSS part', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
  ...
  describe('CSS Parts: Group', () => {
    ...
    it('exposes "error" CSS part when error is set', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" error="Error message">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `);
  ...
  describe('Properties', () => {
    it('value property selects the matching radio', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" value="b">
          <wc-radio value="a" label="A"></wc-radio>
          <wc-radio value="b" label="B"></wc-radio>
          <wc-radio value="c" label="C"></wc-radio>
        </wc-radio-group>
      `);
      const radios = Array.from(el.querySelectorAll('wc-radio')) as WcRadio[];
    ...
    it('required shows asterisk marker in legend', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" required>
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `);
    ...
    it('disabled reflects to host attribute', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" disabled>
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `);
    ...
    it('orientation can be set to horizontal', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" orientation="horizontal">
          <wc-radio value="a" label="A"></wc-radio>
          <wc-radio value="b" label="B"></wc-radio>
        </wc-radio-group>
      `);
  ...
  describe('Error & Help Text', () => {
    it('renders error message in role="alert" div', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" error="Please select an option">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `);
    ...
    it('error div has aria-live="polite"', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" error="Error">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `);
    ...
    it('renders help text below group', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" help-text="Select one option">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `);
    ...
    it('error hides help text', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" error="Error" help-text="Help">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `);
      const helpText = shadowQuery(el, '.fieldset__help-text');
  ...
  describe('Events', () => {
    it('dispatches wc-change when a radio is selected', async () => {
      ...
      const radioB = el.querySelector('wc-radio[value="b"]') as WcRadio;
    ...
    it('wc-change bubbles and is composed', async () => {
      ...
      `);
      const eventPromise = oneEvent<CustomEvent>(el, 'wc-change');
      const radioA = el.querySelector('wc-radio[value="a"]') as WcRadio;
    ...
    it('does not dispatch wc-change when selecting the already-selected radio', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" value="a">
          <wc-radio value="a" label="A"></wc-radio>
          <wc-radio value="b" label="B"></wc-radio>
        </wc-radio-group>
      `);
      let eventFired = false;
      el.addEventListener('wc-change', () => {
        eventFired = true;
      });
      const radioA = el.querySelector('wc-radio[value="a"]') as WcRadio;
      const label = shadowQuery(radioA, '.radio') as HTMLDivElement;
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('ArrowDown wraps from last to first', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" value="c">
          <wc-radio value="a" label="A"></wc-radio>
          <wc-radio value="b" label="B"></wc-radio>
          <wc-radio value="c" label="C"></wc-radio>
        </wc-radio-group>
      `);
      const radioC = el.querySelector('wc-radio[value="c"]') as WcRadio;
      radioC.focus();
      const eventPromise = oneEvent<CustomEvent>(el, 'wc-change');
  ...
  describe('Form Association', () => {
    it('has formAssociated=true', () => {
      const ctor = customElements.get('wc-radio-group') as unknown as { formAssociated: boolean };
    ...
    it('form getter returns associated form', async () => {
      ...
      form.innerHTML = `
        <wc-radio-group label="Test" name="test">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `;
      document.getElementById('test-fixture-container')!.appendChild(form);
      const el = form.querySelector('wc-radio-group') as WcRadioGroup;
      await el.updateComplete;
  ...
  describe('Validation', () => {
    ...
    it('checkValidity returns true when required and value is set', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test" required value="a">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
      `);
  ...
  describe('Accessibility', () => {
    ...
    it('wc-radio contains a hidden native radio input', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test">
          <wc-radio value="a" label="A"></wc-radio>
        </wc-radio-group>
  ...
  describe('Disabled Behavior', () => {
    ...
    it('disabled radio is not selectable via click', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test">
          <wc-radio value="a" label="A" disabled></wc-radio>
          <wc-radio value="b" label="B"></wc-radio>
        </wc-radio-group>
      `);
      let eventFired = false;
  ...
  describe('Slot Content', () => {
    it('wc-radio default slot overrides label property', async () => {
      const el = await fixture<WcRadioGroup>(`
        <wc-radio-group label="Test">
          <wc-radio value="a" label="Fallback"><strong>Custom Label</strong></wc-radio>
        </wc-radio-group>
      `);
      const radio = el.querySelector('wc-radio') as WcRadio;
  ...
  describe('Accessibility (axe-core)', () => {
    ...
    it('has no axe violations in default state', async () => {
      const el = await fixture<WcRadioGroup>(`<wc-radio-group label="Color" name="color">
        <wc-radio value="red" label="Red"></wc-radio>
        <wc-radio value="blue" label="Blue"></wc-radio>
      </wc-radio-group>`);
    ...
    it('has no axe violations with selection', async () => {
      const el = await fixture<WcRadioGroup>(`<wc-radio-group label="Color" name="color" value="red">
        <wc-radio value="red" label="Red"></wc-radio>
        <wc-radio value="blue" label="Blue"></wc-radio>
      </wc-radio-group>`);
      const { violations } = await checkA11y(el, axeOptions);
    ...
    it('has no axe violations in error state', async () => {
      const el = await fixture<WcRadioGroup>(`<wc-radio-group label="Color" name="color" error="Required">
        <wc-radio value="red" label="Red"></wc-radio>
        <wc-radio value="blue" label="Blue"></wc-radio>
      </wc-radio-group>`);
      const { violations } = await checkA11y(el, axeOptions);
