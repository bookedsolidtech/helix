...
import { wcAlertStyles } from './wc-alert.styles.js';
 ...
 *
 * @fires {CustomEvent<{reason: string}>} wc-close - Dispatched when the user dismisses the alert.
 ...
 *
 * @cssprop [--wc-alert-bg=var(--wc-color-info-50)] - Alert background color.
 * @cssprop [--wc-alert-color=var(--wc-color-info-800)] - Alert text color.
 * @cssprop [--wc-alert-border-color=var(--wc-color-info-200)] - Alert border color.
 * @cssprop [--wc-alert-border-radius=var(--wc-border-radius-md)] - Alert border radius.
 * @cssprop [--wc-alert-border-width=var(--wc-border-width-thin)] - Alert border width.
 * @cssprop [--wc-alert-padding=var(--wc-space-4)] - Alert padding.
 * @cssprop [--wc-alert-gap=var(--wc-space-3)] - Gap between alert elements.
 * @cssprop [--wc-alert-icon-color=var(--wc-color-info-500)] - Alert icon color.
 * @cssprop [--wc-alert-font-family=var(--wc-font-family-sans)] - Alert font family.
 */
@customElement('wc-alert')
export class WcAlert extends LitElement {
  static override styles = [tokenStyles, wcAlertStyles];
