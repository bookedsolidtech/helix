...
export const Info: Story = {
  ...
  play: async ({ canvasElement }) => {
    const alert = canvasElement.querySelector('wc-alert');
...
export const WithActions: Story = {
  render: () => html`
    <wc-alert variant="warning" closable>
      This patient has a pending lab result that may affect treatment.
      <wc-button slot="actions" variant="ghost" wc-size="sm">View Results</wc-button>
      <wc-button slot="actions" variant="ghost" wc-size="sm">Dismiss</wc-button>
    </wc-alert>
  `,
};
