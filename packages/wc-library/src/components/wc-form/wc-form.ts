...
import { wcFormScopedCss } from './wc-form.styles.js';
 ...
 *
 * @cssprop [--wc-form-gap=var(--wc-space-4)] - Gap between form fields.
 * @cssprop [--wc-form-max-width=none] - Maximum width of the form.
 * @cssprop [--wc-form-padding=0] - Internal padding of the form.
 */
...
export class WcForm extends LitElement {
  ...
  private _styles = new AdoptedStylesheetsController(this, wcFormScopedCss, document);
