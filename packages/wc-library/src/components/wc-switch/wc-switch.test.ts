...
describe('wc-switch', () => {
  ...
  describe('Rendering', () => {
    it('renders with shadow DOM', async () => {
      const el = await fixture<WcSwitch>('<wc-switch></wc-switch>');
  ...
  describe('Property: checked', () => {
    ...
    it('reflects checked attribute', async () => {
      const el = await fixture<WcSwitch>('<wc-switch checked></wc-switch>');
  ...
  describe('Property: disabled', () => {
    it('sets disabled on the track button', async () => {
      const el = await fixture<WcSwitch>('<wc-switch disabled></wc-switch>');
  ...
  describe('Property: required', () => {
    it('shows required marker asterisk', async () => {
      const el = await fixture<WcSwitch>('<wc-switch label="Accept" required></wc-switch>');
    ...
    it('sets aria-required="true" on track', async () => {
      const el = await fixture<WcSwitch>('<wc-switch required></wc-switch>');
      const track = shadowQuery(el, '[role="switch"]');
  ...
  describe('Property: size', () => {
    ...
    it('reflects wc-size attribute for sm', async () => {
      const el = await fixture<WcSwitch>('<wc-switch wc-size="sm"></wc-switch>');
      expect(el.size).toBe('sm');
      expect(el.getAttribute('wc-size')).toBe('sm');
    });

    it('applies size class to container', async () => {
      const el = await fixture<WcSwitch>('<wc-switch wc-size="lg"></wc-switch>');
  ...
  describe('Property: label', () => {
    it('renders label text', async () => {
      const el = await fixture<WcSwitch>('<wc-switch label="Dark mode"></wc-switch>');
      const label = shadowQuery(el, '[part="label"]');
      expect(label?.textContent?.trim()).toContain('Dark mode');
    });

    it('label is clickable and toggles switch', async () => {
      const el = await fixture<WcSwitch>('<wc-switch label="Toggle me"></wc-switch>');
    ...
    it('track has aria-labelledby pointing to label id', async () => {
      const el = await fixture<WcSwitch>('<wc-switch label="Notifications"></wc-switch>');
      const track = shadowQuery(el, '[role="switch"]');
      const label = shadowQuery(el, '[part="label"]');
  ...
  describe('Property: error', () => {
    it('renders error message in role="alert" div', async () => {
      const el = await fixture<WcSwitch>('<wc-switch error="Must accept terms"></wc-switch>');
    ...
    it('error div has aria-live="polite"', async () => {
      const el = await fixture<WcSwitch>('<wc-switch error="Error"></wc-switch>');
    ...
    it('error hides help text', async () => {
      const el = await fixture<WcSwitch>('<wc-switch error="Error" help-text="Help"></wc-switch>');
  ...
  describe('Property: helpText', () => {
    it('renders help text below switch', async () => {
      const el = await fixture<WcSwitch>('<wc-switch help-text="Toggle to enable"></wc-switch>');
      const helpText = shadowQuery(el, '.switch__help-text');
    ...
    it('help text hidden when error present', async () => {
      const el = await fixture<WcSwitch>('<wc-switch help-text="Help" error="Error"></wc-switch>');
      const helpText = shadowQuery(el, '.switch__help-text');
      expect(helpText).toBeNull();
    });
  });
  ...
  describe('Events', () => {
    ...
    it('wc-change detail.checked reflects new state', async () => {
      const el = await fixture<WcSwitch>('<wc-switch></wc-switch>');
      const track = shadowQuery<HTMLElement>(el, '.switch__track');
      const eventPromise = oneEvent<CustomEvent>(el, 'wc-change');
      track?.click();
  ...
  describe('Slots', () => {
    it('default slot overrides label prop text', async () => {
      const el = await fixture<WcSwitch>('<wc-switch label="Prop Label"><strong>Slot Label</strong></wc-switch>');
    ...
    it('help-text slot renders', async () => {
      const el = await fixture<WcSwitch>('<wc-switch help-text="default"><em slot="help-text">Custom help</em></wc-switch>');
  ...
  describe('CSS Parts', () => {
    ...
    it('label part exposed', async () => {
      const el = await fixture<WcSwitch>('<wc-switch label="Test"></wc-switch>');
      const label = shadowQuery(el, '[part="label"]');
  ...
  describe('Form', () => {
    it('has formAssociated=true', () => {
      const ctor = customElements.get('wc-switch') as unknown as { formAssociated: boolean };
    ...
    it('form getter returns associated form', async () => {
      ...
      form.innerHTML = '<wc-switch name="toggle"></wc-switch>';
      document.getElementById('test-fixture-container')!.appendChild(form);
      const el = form.querySelector('wc-switch') as WcSwitch;
      await el.updateComplete;
  ...
  describe('Validation', () => {
    ...
    it('checkValidity returns true when required + checked', async () => {
      const el = await fixture<WcSwitch>('<wc-switch required checked></wc-switch>');
  ...
  describe('Accessibility', () => {
    ...
    it('aria-describedby references error ID when error set', async () => {
      const el = await fixture<WcSwitch>('<wc-switch error="Bad"></wc-switch>');
      const track = shadowQuery(el, '[role="switch"]');
      const errorDiv = shadowQuery(el, '.switch__error');
    ...
    it('aria-describedby references help text ID when helpText set', async () => {
      const el = await fixture<WcSwitch>('<wc-switch help-text="Some help"></wc-switch>');
      const track = shadowQuery(el, '[role="switch"]');
  ...
  describe('Property: value', () => {
    ...
    it('accepts custom value attribute', async () => {
      const el = await fixture<WcSwitch>('<wc-switch value="yes"></wc-switch>');
  ...
  describe('Property: name', () => {
    it('sets name property', async () => {
      const el = await fixture<WcSwitch>('<wc-switch name="toggle"></wc-switch>');
  ...
  describe('Accessibility (axe-core)', () => {
    it('has no axe violations in default state', async () => {
      const el = await fixture<WcSwitch>('<wc-switch label="Enable notifications"></wc-switch>');
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
    });

    it('has no axe violations when checked', async () => {
      const el = await fixture<WcSwitch>('<wc-switch label="Enable notifications" checked></wc-switch>');
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
    });

    it('has no axe violations when disabled', async () => {
      const el = await fixture<WcSwitch>('<wc-switch label="Enable notifications" disabled></wc-switch>');
      const { violations } = await checkA11y(el);
      expect(violations).toEqual([]);
    });
  });
