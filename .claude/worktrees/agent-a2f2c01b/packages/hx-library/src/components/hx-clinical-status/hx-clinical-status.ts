...
export class HelixClinicalStatus extends LitElement {
  ...
  override render() {
    ...
    return html`
      ...
      >
        ...
        <div part="message" class="clinical-status__message">
          ${this.message}
          ${this._hasSlottedContent
            ? html`<div class="clinical-status__slot-content"><slot @slotchange=${this._handleSlotChange}></slot></div>`
