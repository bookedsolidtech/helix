...
const SEVERITY: ReadonlySet<Severity> = new Set([
  "critical",
  "high",
  "medium",
  "low",
...
const VERDICT: ReadonlySet<Verdict> = new Set([
  "pass",
  "concerns",
  "blocking",
  "error",
...
export function validateFinding(value: unknown): ValidationResult {
  ...
  if (
    typeof f.verdict_for_target !== "string" ||
    !VERDICT.has(f.verdict_for_target as Verdict)
  ) {
