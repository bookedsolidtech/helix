...
export class ChcButton extends LitElement {
  static styles = css`
    :host {
      ...
      --_button-bg: var(--chc-button-background-primary-default, var(--hds-color-interactive-primary-default));
    ...
    :host(:hover) {
      --_button-bg: var(--chc-button-background-primary-hover, var(--hds-color-interactive-primary-hover));
    }
  `;
}
```
