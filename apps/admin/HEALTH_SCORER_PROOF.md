...
## Real-World Validation: hx-card Component
...
hx-card demonstrates the algorithm preventing gaming:
...
| ------------- | -------------- | ----- | ------------------ | ------------------------------------- |
| hx-button     | 85             | **B** | None               | All critical ≥70%, 1 untested allowed |
| hx-card       | 85             | **C** | Type Safety (63%)  | Below B threshold (70%)               |
| hx-text-input | 87             | **B** | None               | All critical ≥70%, 1 untested allowed |

**Key Insight**: hx-card and hx-button have nearly identical weighted scores (85), but hx-card receives C instead of B due to Type Safety weakness. This is the algorithm working as designed.
...
- ✅ hx-card downgraded due to 63% type safety
...
**Real-world proof**: hx-card receives C grade despite 85/100 weighted score due to Type Safety weakness (63% < 70% B threshold).
