...
export const hooks: Hook[] = [
  ...
  },
  {
    ...
    owner: 'Lit Specialist',
    priority: 'P1',
    purpose: 'Detect CSS leaks from Shadow DOM boundaries',
    workflow: 'Pre-push hook runs custom linter to validate CSS encapsulation',
    executionBudget: '<5s',
    phase: 3,
    dependencies: ['H10'],
    status: 'planned',
  },
  {
    ...
    owner: 'TypeScript Specialist',
    priority: 'P1',
    purpose: 'Block any TypeScript `any` types in component code',
    workflow: 'Pre-commit hook runs grep for `any` in staged TS files, fails if found',
    executionBudget: '<1s',
    phase: 3,
    dependencies: ['H01'],
    status: 'planned',
  },
  {
    ...
    priority: 'P1',
    purpose: 'Detect breaking changes to public component APIs',
  ...
  },
  {
    ...
    owner: 'Performance Engineer',
    priority: 'P1',
    purpose: 'Run Lighthouse performance audits on Storybook stories',
    workflow: 'Pre-push hook runs Lighthouse on affected story pages, fails if score <90',
    executionBudget: '<45s',
    phase: 3,
    dependencies: ['H09'],
    status: 'planned',
  ...
  // Phase 3: Advanced Checks (P2)
  {
    ...
    priority: 'P2',
    purpose: 'Validate animation durations meet accessibility guidelines (200-500ms)',
    workflow: 'Pre-commit hook parses CSS animations, validates timing against WCAG',
    executionBudget: '<2s',
    phase: 3,
    dependencies: ['H06'],
    status: 'planned',
  },
  {
    ...
    priority: 'P2',
    purpose: 'Block commits that add vulnerable or duplicate dependencies',
    workflow: 'Pre-commit hook runs `npm audit` and duplicate-package-checker',
    executionBudget: '<8s',
    phase: 3,
    dependencies: [],
    status: 'planned',
  ...
  // Phase 4: Polish & Optimization (P2)
  {
    ...
    priority: 'P2',
    purpose: 'Ensure all public APIs have JSDoc documentation',
  ...
  },
  {
    ...
    owner: 'Design System Developer',
    priority: 'P2',
    purpose: 'Validate all CSS parts are documented in CEM',
