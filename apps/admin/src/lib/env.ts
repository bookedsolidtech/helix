...
export const DOCS_URL = process.env.NEXT_PUBLIC_HELIX_DOCS_URL || 'http://localhost:3150';
export const STORYBOOK_URL = process.env.NEXT_PUBLIC_HELIX_STORYBOOK_URL || 'http://localhost:3151';
