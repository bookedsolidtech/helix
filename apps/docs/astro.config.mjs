      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Theme Marketplace', slug: 'enterprise/theme-marketplace' },
            { label: 'Theme Submission', slug: 'enterprise/theme-submission' },
            { label: 'Support Tiers', slug: 'enterprise/support' },
            { label: 'SLA Templates', slug: 'enterprise/sla' },
            { label: 'Training & Certification', slug: 'enterprise/training' },
          ],
        },
      ],
    }),
