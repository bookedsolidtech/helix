    ...
    init();
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            // Per-component MDX duplicates were removed (2026-05-10) — they
            // duplicated the CEM-driven autodocs in Storybook. The live demo
            // overview here is the entry point; per-component reference lives
            // in Storybook at https://storybook.helix.bookedsolid.tech.
          ...
          items: [
            {
              ...
              items: [
                ...
                // Fundamentals tutorial tree (Lit primer) was removed
                // (2026-05-10) — out-of-scope for HELiX docs. Refer
                // contributors to the official Lit documentation at
                // https://lit.dev/docs/.
                {
                  label: 'Shadow DOM',
                  collapsed: true,
            ...
            // drupal-integration/ tree was removed (2026-05-10) — the
            // substantial Drupal content lives in `drupal/` (module install,
            // CDN install, behaviors, performance). drupal-integration/ was
            // mostly stubs and parallel duplicates.
            {
              label: 'Theming',
              slug: 'guides/theming',
            },
