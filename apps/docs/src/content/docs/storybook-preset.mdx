...
const preview: Preview = {
  parameters: {
    ...
    // Pseudo-states + designs panels register on empty defaults; per-story
    // overrides supply the actual frame URL or the forced state.
    pseudo: {},
    design: {},
  },
...
No other configuration changes are required — the addons register on empty
defaults and become visible as soon as a story sets the corresponding
parameter.
