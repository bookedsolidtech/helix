...
- Read [Lit: Templates Overview](https://lit.dev/docs/templates/overview/) for Lit's `html` tagged template
- Explore [Lit: Reactive Properties](https://lit.dev/docs/components/properties/) for property lifecycle
- Review [Lit: Component Lifecycle](https://lit.dev/docs/components/lifecycle/) for component lifecycle
