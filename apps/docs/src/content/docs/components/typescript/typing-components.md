...
- Read [Template Syntax](https://lit.dev/docs/templates/overview/) on lit.dev for Lit's `html` tagged template
- Explore [Reactive Properties](https://lit.dev/docs/components/properties/) on lit.dev for property lifecycle
- Review [Lifecycle Methods](https://lit.dev/docs/components/lifecycle/) on lit.dev for component lifecycle
