...
Once `@wc-2026/library` is published to npm, the CDN bundles are automatically available via jsDelivr and unpkg.
...
<script
  type="module"
  src="https://cdn.jsdelivr.net/npm/@wc-2026/library@2/dist-cdn/hx-library.es.js"
></script>

<!-- Pinned to exact version (recommended for production) -->
<script
  type="module"
  src="https://cdn.jsdelivr.net/npm/@wc-2026/library@2.3.1/dist-cdn/hx-library.es.js"
></script>
```
...
<script
  type="module"
  src="https://unpkg.com/@wc-2026/library@2.3.1/dist-cdn/hx-library.es.js"
></script>
```
...
helix-components:
  ...
  js:
    ...
    https://cdn.jsdelivr.net/npm/@wc-2026/library@2.3.1/dist-cdn/hx-library.es.js:
      type: external
      minified: true
      attributes:
        type: module
...
<script
  type="module"
  src="https://cdn.jsdelivr.net/npm/@wc-2026/library@latest/dist-cdn/hx-library.es.js"
></script>
...
https://cdn.jsdelivr.net/npm/@wc-2026/library@{VERSION}/dist-cdn/hx-library.es.js

# Per-component (when using import maps)
https://cdn.jsdelivr.net/npm/@wc-2026/library@{VERSION}/dist-cdn/components/hx-button.js
```
...
<script type="importmap">
  {
    "imports": {
      ...
      "@wc-2026/library/components/hx-button": "https://cdn.jsdelivr.net/npm/@wc-2026/library@2.3.1/dist-cdn/components/hx-button.js",
      "@wc-2026/library/components/hx-card": "https://cdn.jsdelivr.net/npm/@wc-2026/library@2.3.1/dist-cdn/components/hx-card.js"
    }
  }
</script>
...
<html>
  <head>
    <script type="importmap">
      {
        "imports": {
          ...
          "@wc-2026/library/": "https://cdn.jsdelivr.net/npm/@wc-2026/library@2.3.1/dist/"
        }
      }
    </script>
    ...
    <script type="module">
      import '@wc-2026/library/components/hx-button/index';
      import '@wc-2026/library/components/hx-card/index';
    </script>
  </head>
  <body>
...
npm run build:cdn --workspace=@wc-2026/library
