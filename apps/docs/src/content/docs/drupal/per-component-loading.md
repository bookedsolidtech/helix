...
description: Complete implementation guide for tree-shaking HELiX components via Drupal's library system — runtime + per-component libraries + convenience groups, preprocess functions, performance budgets, and dynamic loading.
sidebar:
  order: 14
---

This document provides a complete implementation guide for **per-component loading** — the recommended strategy for loading HELiX web components in Drupal. This approach treats each component as an independent Drupal library, enabling surgical payload control and maintaining a strict performance budget of <50KB per page.
...
## Appendix A: Performance Budget Calculator
...
## Appendix B: Migration from Monolithic Bundle
...
- [Drupal Integration Best Practices](/drupal/best-practices/)
- [SDC Composition Architecture](/drupal/sdc/composition/)
- [Performance Overview](/drupal/performance/overview/)
- [Lazy Loading](/drupal/performance/lazy-loading/)
