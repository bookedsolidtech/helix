...
description: Comprehensive guide to Drupal's asset library system for HELiX web components — libraries.yml syntax, dependencies, versioning, weight, attributes, tree-shaking, and loading strategies.
sidebar:
  order: 13
---
...
- [Per-Component Loading Strategy](/drupal/per-component-loading/)
- [Drupal Integration Best Practices](/drupal/best-practices/)
- [CDN Installation](/drupal/installation/cdn/)
- [npm Installation](/drupal/installation/npm/)
