...
helix-button:
  js:
    https://cdn.jsdelivr.net/npm/@helixui/library@3.9.0/dist/hx-button.js:
      type: external
      attributes:
        type: module
  version: 3.9.0
...
helix-card:
  js:
    https://cdn.jsdelivr.net/npm/@helixui/library@3.9.0/dist/hx-card.js:
      type: external
      attributes:
        type: module
  version: 3.9.0
...
<Aside type="note" title="Reference">
  See **ADR-DRUPAL-001** in the HELiX documentation for detailed guidance on choosing between
  property-driven and slot-driven patterns.
</Aside>
...
<Aside type="note" title="Reference">
  See **ADR-DRUPAL-002** for event handling best practices, including custom event naming
  conventions and cleanup patterns.
</Aside>
...
<Aside type="note" title="Reference">
  See **ADR-DRUPAL-003** for comprehensive performance optimization strategies, including HTTP/2
  server push, asset aggregation, and lazy loading patterns.
</Aside>
...
<Aside type="note" title="Reference">
  See **ADR-DRUPAL-004** for accessibility best practices, including ARIA patterns, focus
  management, and screen reader compatibility in Drupal workflows.
</Aside>
...
<Aside type="tip" title="Next Steps">
  Review individual component documentation (hx-card, hx-select, hx-form) for specific Drupal
  integration examples. See the visual ADRs in the HELiX documentation site for detailed
...
The following measurements come from production healthcare site deployments comparing a traditional jQuery-based Drupal theme to an equivalent HELiX SDC implementation.
...
```bash
curl -s https://cdn.jsdelivr.net/npm/@helixui/library@3.9.0/dist/cdn/core.js | \
