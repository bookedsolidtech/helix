...
import '@helixui/library/components/hx-prose/index';
```
...
```html
<hx-prose hx-size="lg" max-width="72ch">
...
| ---------- | ----------- | ------------------------ | -------- | --------------------------------------------------------------------------------------------------------------------------- |
| `size`     | `hx-size`   | `'sm' \| 'base' \| 'lg'` | `'base'` | Typography scale for the prose content. Sets `--hx-prose-font-size` to the corresponding size token.                        |
...
<html lang="en">
  <head>
    ...
    <script type="module">
      ...
      // In your project: import '@helixui/library/components/hx-prose/index'
  ...
  <body style="font-family: sans-serif; padding: 2rem; max-width: 960px;">
    ...
    <hx-prose hx-size="lg" max-width="720px">
