...
| `labelMenu` | `label-menu` | `string`                                                                                                                                                             | `'Actions'`      | Accessible label applied as `aria-label` on the floating panel (`role="menu"`). Override when the default `"Actions"` label is insufficiently descriptive. |
