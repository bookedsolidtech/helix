...
<ComponentDemo title="Decorative Spinner">
  <div style="display: flex; align-items: center; gap: 0.75rem; padding: 1rem; border: 1px solid #e5e7eb; border-radius: 0.5rem; max-width: 320px;">
    <hx-spinner hx-size="sm" variant="primary" decorative></hx-spinner>
...
| ------------ | ------------ | -------------------------------------- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `size`       | `hx-size`    | `'sm' \| 'md' \| 'lg' \| string`       | `'md'`      | Size of the spinner. Use token values for standard sizing, or any valid CSS size string (e.g. `"3rem"`, `"48px"`) for custom sizes. Reflects to attribute.                                |
...
<html lang="en">
  ...
  >
    ...
    <section>
      ...
      >
        <hx-spinner id="save-spinner" hx-size="sm" variant="primary" decorative></hx-spinner>
    ...
    >
      ...
      >
        <hx-spinner hx-size="lg" variant="primary" label="Refreshing lab results"></hx-spinner>
      </div>
    </section>
