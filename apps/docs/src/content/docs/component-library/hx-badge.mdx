...
<ComponentDemo title="Pill Shape">
  <div style="display: flex; gap: 0.75rem; flex-wrap: wrap; align-items: center;">
    <hx-badge variant="primary" pill>Primary</hx-badge>
    <hx-badge variant="success" pill>Active</hx-badge>
    <hx-badge variant="error" pill>Critical</hx-badge>
  </div>
</ComponentDemo>
...
<ComponentDemo title="Pulse Animation">
  <div style="display: flex; gap: 0.75rem; flex-wrap: wrap; align-items: center;">
    <hx-badge variant="error" pulse>3</hx-badge>
    <hx-badge variant="success" pulse>Live</hx-badge>
    <hx-badge variant="warning" pulse pill>Alert</hx-badge>
  </div>
</ComponentDemo>
