...
<ComponentDemo title="With Swatches">
  ...
  <script>{`
    document.getElementById('demo-swatches').swatches = ['#ef4444', '#f97316', '#eab308', '#22c55e', '#3b82f6', '#8b5cf6', '#ec4899'];
  `}</script>
</ComponentDemo>
...
<ComponentDemo title="Swatches Only">
  ...
  ></hx-color-picker>
  <script>{`
    document.getElementById('demo-swatches-only').swatches = ['#ef4444', '#f97316', '#eab308', '#22c55e', '#3b82f6', '#8b5cf6'];
  `}</script>
</ComponentDemo>
...
| `required`     | `required`      | `boolean`                          | `false`     | When true, a color value must be selected for form validity.                            |
...
| Topic                          | Details                                                                                                                                                                                       |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ARIA role                      | Trigger: native `button` with `aria-haspopup="dialog"` and `aria-expanded`. Panel: `role="group"` with `aria-label="Color picker"`.                                                           |
