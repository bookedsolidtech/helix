...
<ComponentDemo title="Item Types">
  <hx-menu accessible-label="Item types" style="max-width: 240px;">
...
<ComponentDemo title="States">
  <hx-menu accessible-label="Item states" style="max-width: 240px;">
...
<ComponentDemo title="Prefix and Suffix Slots">
  <hx-menu accessible-label="Slotted items" style="max-width: 240px;">
...
<html lang="en">
  ...
  <body style="font-family: sans-serif; padding: 2rem;">
    <hx-menu id="action-menu" accessible-label="Patient actions" style="max-width: 220px;">
