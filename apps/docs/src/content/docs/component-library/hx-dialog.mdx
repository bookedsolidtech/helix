...
| `labelClose`      | `label-close`       | `string`                    | `'Close dialog'` | Accessible label for the built-in close button (`aria-label`). Override to localise or provide context-specific text.                                                                                                                                                                      |
...
<hx-dialog accessible-label="Critical Alert">
  <div slot="header">
