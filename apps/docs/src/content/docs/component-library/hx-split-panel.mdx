...
| `resizeLabel`        | `resize-label`         | `string`                     | `'Resize panels'`        | Accessible label for the divider handle. Announced to screen readers as the element's accessible name. Override for localization. Reflects to attribute. |
| `collapseStartLabel` | `collapse-start-label` | `string`                     | `'Collapse start panel'` | Accessible label for the collapse-start button when `collapsible` is set. Override for localization. Reflects to attribute.                              |
| `collapseEndLabel`   | `collapse-end-label`   | `string`                     | `'Collapse end panel'`   | Accessible label for the collapse-end button when `collapsible` is set. Override for localization. Reflects to attribute.                                |
