...
Items that have `children` render as expandable dropdown triggers with `aria-expanded`.
...
| `labelOpenMenu`  | `label-open-menu`  | `string`                     | `'Open navigation menu'`  | Accessible label for the hamburger toggle button when the mobile menu is closed.                              |
| `labelCloseMenu` | `label-close-menu` | `string`                     | `'Close navigation menu'` | Accessible label for the hamburger toggle button when the mobile menu is open.                                |
