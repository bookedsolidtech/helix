...
<ComponentDemo title="Validation States">
  <div style="display: grid; gap: 1rem; max-width: 400px;">
    <hx-text-input label="Valid input" value="jane@example.com" help-text="Looks good!"></hx-text-input>
    <hx-text-input label="Error input" value="bad" error="Too short — minimum 8 characters."></hx-text-input>
