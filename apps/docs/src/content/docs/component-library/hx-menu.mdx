...
<ComponentDemo title="Basic Menu">
  <hx-menu accessible-label="Action menu" style="max-width: 200px;">
...
<ComponentDemo title="With Prefix Icons">
  <hx-menu accessible-label="File menu" style="max-width: 220px;">
...
<ComponentDemo title="Checkbox Items">
  <hx-menu accessible-label="View options" style="max-width: 240px;">
...
<ComponentDemo title="Radio Items">
  <hx-menu accessible-label="Sort order" style="max-width: 240px;">
...
<ComponentDemo title="With Keyboard Shortcuts">
  <hx-menu accessible-label="Edit menu" style="max-width: 220px;">
...
<ComponentDemo title="Loading State">
  <hx-menu accessible-label="Processing menu" style="max-width: 200px;">
...
```html
<hx-menu accessible-label="Actions">
  <hx-menu-item value="edit">Edit</hx-menu-item>
  <hx-menu-item value="duplicate">Duplicate</hx-menu-item>
  <hx-menu-divider></hx-menu-divider>
  <hx-menu-item value="delete">Delete</hx-menu-item>
...
| -------- | --------- | -------- | ------- | ---------------------------------------------------------------------------------------------------------------------- |
| `label`  | `label`   | `string` | `''`    | Accessible label rendered as `aria-label` on the inner `role="menu"` element. A console warning is emitted if not set. |
...
| Accessible name | Set the `label` property (or `label` attribute) on `<hx-menu>`. This populates `aria-label` on the inner `role="menu"` element. A dev warning is emitted at runtime if `label` is omitted. |
...
<hx-menu accessible-label="{{ label }}">
  {% for item in items %}
    {% if item.divider %}
      <hx-menu-divider></hx-menu-divider>
    {% else %}
...
<html lang="en">
  ...
  <body style="font-family: sans-serif; padding: 2rem;">
    <hx-menu id="my-menu" accessible-label="Document actions" style="max-width: 200px;">
      <hx-menu-item value="edit">Edit</hx-menu-item>
      <hx-menu-item value="duplicate">Duplicate</hx-menu-item>
      <hx-menu-divider></hx-menu-divider>
      <hx-menu-item value="delete">Delete</hx-menu-item>
