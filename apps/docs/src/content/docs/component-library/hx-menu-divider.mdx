...
<ComponentDemo title="Menu with Dividers">
  <hx-menu accessible-label="Document actions" style="max-width: 220px;">
...
<hx-menu accessible-label="{{ menu_label }}">
...
<html lang="en">
  ...
  <body style="font-family: sans-serif; padding: 2rem;">
    <hx-menu accessible-label="Patient record actions" style="max-width: 220px;">
