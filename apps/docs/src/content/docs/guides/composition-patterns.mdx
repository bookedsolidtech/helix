...
```html
<hx-top-nav accessible-label="Primary navigation">
  <a slot="logo" href="/">
  ...
  <div slot="actions">
    <hx-button variant="ghost" accessible-label="Notifications (3 unread)">
...
<div class="app-layout">
  <hx-side-nav accessible-label="Section navigation">
    <nav>
  ...
  <main id="main-content">
    <hx-breadcrumb accessible-label="Breadcrumb">
      <ol>
        <li><a href="/">Home</a></li>
...
<hx-tabs>
  <hx-tab-list accessible-label="Medication views">
...
<hx-data-table id="patient-list" accessible-label="Patient list" sortable>
...
<hx-pagination
  ...
  page-size="25"
  current-page="1"
  accessible-label="Patient list pagination"
></hx-pagination>
```
...
<hx-drawer id="patient-detail-drawer" position="end" size="lg" aria-labelledby="drawer-title">
  ...
  <div class="patient-detail-content">
    <hx-tabs>
      <hx-tab-list accessible-label="Patient detail sections">
...
<hx-toast-region accessible-label="Notifications" position="top-end"></hx-toast-region>
...
<hx-card variant="default" class="appointment-scheduler">
  ...
  <hx-steps current-step="1" total-steps="3" accessible-label="Appointment scheduling progress">
