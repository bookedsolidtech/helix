...
- [Lit Properties Guide](https://lit.dev/docs/components/properties/) — Deep dive into the property/attribute duality in Lit components
- [Lit Template Syntax](https://lit.dev/docs/templates/expressions/) — Lit binding syntax reference including `?boolean` bindings
