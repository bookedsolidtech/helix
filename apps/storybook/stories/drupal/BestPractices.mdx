...
```bash
cp -r node_modules/@helix/library/dist /path/to/drupal/libraries/helix/
```
...
helix-button:
  js:
    https://cdn.jsdelivr.net/npm/@helix/library@1.0.0/dist/hx-button.js:
      type: external
      attributes:
        type: module
  version: 1.0.0
...
helix-card:
  js:
    https://cdn.jsdelivr.net/npm/@helix/library@1.0.0/dist/hx-card.js:
      type: external
      attributes:
        type: module
  version: 1.0.0
...
- **Design Tokens**: See `@helix/library` token documentation
