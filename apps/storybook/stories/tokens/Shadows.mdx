...
// Every use-case below is grounded in an actual *.styles.ts shadow
// binding in packages/hx-library/src/components.
export const shadowUseCases = {
  none: 'Flat elements with no visual lift. Used for inline or flush elements.',
  sm: 'Subtle elevation — hx-slider / hx-switch thumbs and hx-tooltip body.',
  md: 'Moderate depth — hx-card at rest, hx-dropdown / hx-menu / hx-nav / hx-popover surfaces, hx-toast.',
  lg: 'Hover elevation on hx-card (rest is md, hover lifts to lg).',
  xl: 'High elevation for modal surfaces — hx-dialog and hx-drawer; also hx-card deep-hover.',
  '2xl': 'Available token; not currently consumed by any shipped HELiX component. Reserved for consumer custom surfaces.',
  inner: 'Available token; not currently consumed by any shipped HELiX component. Reserved for consumer pressed/recessed-input patterns.',
};
...
<style>
  ...
  .hx-token-shadows .hx-shadows-hero {
    background: linear-gradient(135deg, var(--hx-color-neutral-100, #EBEEE9) 0%, var(--hx-color-neutral-50, #F5F8F3) 100%) !important;
    border-radius: 0.75rem !important;
    padding: 2.5rem 2rem !important;
    margin-bottom: 2.5rem !important;
    border: 1px solid var(--hx-color-neutral-200, #D6DBD5) !important;
  ...
  .hx-token-shadows .hx-shadows-hero::before {
    ...
    background: radial-gradient(circle, var(--hx-color-neutral-200, #D6DBD5) 0%, transparent 70%) !important;
  ...
  .hx-token-shadows .hx-shadows-hero-title {
    ...
    color: var(--hx-color-neutral-900, #0D1825) !important;
  ...
  .hx-token-shadows .hx-shadows-hero-desc {
    ...
    color: var(--hx-color-neutral-500, #66787B) !important;
  ...
  .hx-token-shadows .hx-shadows-hero-badge {
    ...
    background: var(--hx-color-neutral-200, #D6DBD5) !important;
    color: var(--hx-color-neutral-700, #313E4B) !important;
  ...
  .hx-token-shadows .hx-shadows-elevation-grid {
    ...
    background: var(--hx-color-neutral-50, #F5F8F3) !important;
    border-radius: 0.75rem !important;
    border: 1px solid var(--hx-color-neutral-100, #EBEEE9) !important;
  }
  ...
  .hx-token-shadows .hx-shadows-card-name {
    ...
    color: var(--hx-color-neutral-800, #202B39) !important;
  ...
  .hx-token-shadows .hx-shadows-card-token-badge {
    ...
    font-size: 0.75rem !important;
    color: var(--hx-color-neutral-600, #4A5362) !important;
  ...
  .hx-token-shadows .hx-shadows-ref-row:not(:last-child) {
    border-bottom: 1px solid var(--hx-color-neutral-100, #EBEEE9) !important;
  }
  ...
  .hx-token-shadows .hx-shadows-footer {
    ...
    border-top: 1px solid var(--hx-color-neutral-200, #D6DBD5) !important;
    text-align: center !important;
  }
