...
<EyebrowHeading
  ...
  lede={
    <>
      ...
      software failure can impact patient care. Where USWDS publishes a Level&nbsp;AA conformance
      claim, HELiX targets <strong>WCAG&nbsp;2.1&nbsp;Level&nbsp;AAA on its P0 surface</strong> —
      and we ship the contrast ledger, the keyboard contracts, and the VPAT to prove it.
    </>
  }
/>

<section>
  <SectionHead title="The AAA cert posture" meta="WCAG 2.1 · differentiation surface" />
  ...
  <p className="hx-docs-card-body" style={{ marginTop: 16, maxWidth: '70ch' }}>
    The full ledger lives in <strong>Accessibility / Dashboard</strong>. The supplemental pages
    cover forced-colors emulation, the APG-aligned keyboard contracts, focus-management patterns,
    and the per-mode contrast deep-dive — every claim above is verifiable against the regression
    suite.
  </p>
</section>
...
<section>
  ...
  <div className="hx-docs-pillars">
    <article className="hx-docs-pillar">
      ...
      <p>
        The U.S. Web Design System publishes a <strong>Level AA</strong> conformance claim for its
        44 core components — the legal floor for Section&nbsp;508. That posture is correct for civic
        services with a broad-public remit and risk-averse delivery cadence.
      </p>
    </article>
    <article className="hx-docs-pillar">
      ...
      <p>
        ...
        expect <em>headroom</em>. HELiX targets <strong>Level AAA on its P0 surface</strong>
        and publishes the per-component VPAT so consumers can stake their own claim.
      </p>
    </article>
    <article className="hx-docs-pillar">
  ...
  <div className="hx-docs-pillars">
    <article className="hx-docs-pillar">
      ...
      <p>
        ...
        1 (AA floor). The 100 AAA-graded pairs sit at ≥ 7 : 1. Drift below the floor fails CI. Focus
        rings clear 1.4.11 in every mode, including forced-colors.
      </p>
    </article>
    <article className="hx-docs-pillar">
