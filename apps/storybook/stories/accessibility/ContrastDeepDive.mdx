...
<section>
  ...
  <div className="hx-docs-stats">
    <StatCard num="59" label="Light pairs" sub="53 AAA · 6 AA · 0 sub-AA" />
    <StatCard num="58" label="Dark pairs" sub="53 AAA · 5 AA · 0 sub-AA" />
    <StatCard num="46" label="HC pairs" sub="46 AAA · 0 AA · 0 sub-AA" />
    <StatCard num="163" label="Total · 0 sub-AA" sub="152 AAA · 11 AA" />
  </div>
</section>
