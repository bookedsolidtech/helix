...
<section>
  ...
  <div className="hx-docs-stats">
    <StatCard num="59" label="Light pairs" sub="28 AAA · 31 AA · 0 sub-AA" />
    <StatCard num="58" label="Dark pairs" sub="30 AAA · 28 AA · 0 sub-AA" />
    <StatCard num="46" label="HC pairs" sub="42 AAA · 4 AA · 0 sub-AA" />
    <StatCard num="163" label="Total · 0 sub-AA" sub="100 AAA · 63 AA" />
  </div>
</section>
