...
<section>
  ...
  >
    ...
    <StatCard label="Conformance" value="AAA" sublabel="non-text contrast 1.4.11" tone="success" />
  </div>
</section>
...
<section>
  ...
  <p style={{ marginBottom: 16, maxWidth: '70ch' }}>
    ...
    contrast at 16px+ render sizes. Phase 5 of the icons epic migrates internal components
    (hx-checkbox, hx-alert, hx-toast, etc.) to consume these names — re-register <code>helix</code>{' '}
    with your own resolver to override the entire system glyph surface.
  </p>
  <div
    style={{
      display: 'grid',
...
<section>
  ...
  >
    ...
    >
      ...
      libraries inherit the same harness — call <code>iconLibraryAaaVerdict(name)</code> to verify
      before claiming AAA on icon glyphs.
    </DocsCard>
  </div>
</section>
