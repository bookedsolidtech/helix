...
export const HELIX_GLYPHS = [
  'arrow-down', 'arrow-flat', 'arrow-up', 'calendar', 'check',
  'chevron-down', 'chevron-left', 'chevron-right', 'chevron-up',
  'chevrons-left', 'chevrons-right', 'clock', 'close', 'copy', 'dash',
  'dot', 'ellipsis', 'error', 'external-link', 'eye', 'eye-off',
  'file', 'info', 'lock', 'menu', 'plus', 'star-filled', 'star-outline',
  'success', 'trash', 'upload', 'warning',
];

export const FA_FREE_SAMPLE = [
  'address-book', 'bell', 'bookmark', 'calendar', 'chart-line',
  'circle-check', 'circle-exclamation', 'circle-info', 'circle-question',
  'circle-xmark', 'clipboard', 'clock', 'cloud', 'comment', 'envelope',
  'eye', 'file', 'filter', 'gear', 'heart', 'house', 'magnifying-glass',
  'pen', 'star', 'trash', 'user',
];
...
<section>
  ...
  >
    <StatCard
      ...
      value="fa-free"
      sublabel="2,000 FA Free Solid v7"
      tone="info"
    />
    <StatCard
...
<section>
  ...
  <p style={{ marginBottom: 16, maxWidth: '70ch' }}>
    The internal glyph vocabulary every HELiX component renders through. Hand-drawn at 24×24,
    filled silhouettes (no strokes), <code>currentColor</code> only. AAA-validated for WCAG 1.4.11
    non-text contrast at 16px+ render sizes. Phase 5 of the icons epic migrates internal components
    (hx-checkbox, hx-alert, hx-toast, etc.) to consume these names — re-register{' '}
    ...
    <DocsCard
      ...
      demo={
        <code style={{ fontSize: 13 }}>
          {'<hx-icon name="error" label="Critical"></hx-icon>'}
        </code>
      }
    >
  ...
  >
    ...
    <div className="hx-docs-card" style={{ borderColor: 'var(--hx-color-error-500)' }}>
      ...
      <p className="hx-docs-card-body">
        ...
        Stroke-style libraries (Lucide, Phosphor regular) declare{' '}
        <code>paintMode: 'stroke'</code> at registration so the harness can validate them.
      </p>
    </div>
    <div className="hx-docs-card" style={{ borderColor: 'var(--hx-color-error-500)' }}>
      <div className="hx-docs-card-head">
